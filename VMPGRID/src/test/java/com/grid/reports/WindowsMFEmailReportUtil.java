...
public class WindowsMFEmailReportUtil {
	...
	public static void startSuite(String suiteName) {
		...
		try {
			...
			out.write("<td width=3% align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Windows 7 Firefox Version 31.0</b></td>\n");
			out.write("</tr>\n");
			out.close();
		} catch (Exception e) {
			System.err.println("Error: " + e.getMessage());
	...
	public static void addTestCaseSteps(String testCaseID, String TestLinkID,
		...
		try {
			...
			}else if ( (windowsMFStatus!=null && windowsMFStatus.equals("desc"))) {
			...
			if(windowsMFStatus == null){
					out.write("<td width=3% align= center  bgcolor=#CCCCCC><FONT COLOR=#153E7E FACE=Arial SIZE=2><b>Not Run</b></td>\n");
