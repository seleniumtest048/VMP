...
public class MacMFEmailReportUtil {
	...
	public static void startSuite(String suiteName) {
		...
		try {
			...
			out.write("<td width=10% align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Mac Firefox Version 31.0</b></td>\n");
	...
	public static void addTestCaseSteps(String testCaseID, String TestLinkID,
			...
			String macMFStatus, String macMFTestLinkID) {
		newTest = true;
		FileWriter fstream = null;
		BufferedWriter out = null;
		try {
			...
			}else if ( ( macMFStatus != null && macMFStatus.equalsIgnoreCase("desc"))) {
