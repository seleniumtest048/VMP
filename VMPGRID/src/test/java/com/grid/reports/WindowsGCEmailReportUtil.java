...
public class WindowsGCEmailReportUtil {
	...
	public static void startSuite(String suiteName) {
		...
		try {
			...
			out.write("<td width=3% align= center  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2><b>Windows 7 Chrome 36.0</b></td>\n");
			out.write("</tr>\n");
			out.close();
		} catch (Exception e) {
			System.err.println("Error: " + e.getMessage());
	...
	public static void addTestCaseSteps(String testCaseID, String TestLinkID,
			String testCaseDescription, String windowsGCResults,
			String windowGCTestLinkID) {
		newTest = true;
		FileWriter fstream = null;
		BufferedWriter out = null;
		try {
			...
			}else if ((windowsGCResults!=null && windowsGCResults.equals("desc"))) {
