...
public class MacSafariEmailReportUtil {
	...
	public static void addTestCaseSteps(String testCaseID, String TestLinkID,
			String testCaseDescription, String macSafariStatus,String macSafariTestLinkID) {
		newTest = true;
		FileWriter fstream = null;
		BufferedWriter out = null;
		try {
			...
			}else if ( (macSafariStatus!=null && macSafariStatus.equalsIgnoreCase("desc"))) {
